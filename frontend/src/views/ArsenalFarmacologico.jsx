...
const ArsenalFarmacologico = ({ onNavigate }) => {
  // === LINKS DEL ARSENAL ===
  // Si son el mismo link, pega el mismo en los dos lados. 
  // Si son distintos, aquí tienes el espacio para cada uno:
  ...
  return (
    <section className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl border border-slate-100 min-h-[600px] animate-in fade-in zoom-in duration-500 w-full font-sans relative mt-6">
      ...
      <div className="max-w-4xl mx-auto flex flex-col items-start pt-8 pl-4 md:pl-12">
        ...
        >
          {/* Sombra base decorativa parecida a tu imagen */}
          ...
          {/* Línea divisoria debajo del icono como en tu captura */}
